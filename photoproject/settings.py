...
# お使いのものを入力してください
DEFAULT_FROM_EMAIL = 'kaede.teruyama.oohara@gmail.com'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp.gmail.com'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'kaede.teruyama.oohara@gmail.com'     # Gmailのアドレスを入力
EMAIL_HOST_PASSWORD = 'xuev ntdy afmy capj' # Gmailのアプリ用パスワードを入力
